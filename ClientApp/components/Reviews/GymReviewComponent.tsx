...
import { GymReviewPublic, GymFinderBasic, UpvoteItems } from '../../data/serverModels';
...
export class GymReviewComponent extends React.Component<ModuleProps, Modulestate> {
    ...
    public render() {
        ...
        return <div className="reviewContainer">
            ...
            <div hidden={r.review.reviewerId != GetUserID() && !AdminLoggedIn()} className="text-right">
                <button className="btn btn-primary btn-sm" onClick={() => this.props.Props.history.push(Pages.gymreview, { review: r.review, gym: this.props.Gym })}>Edit</button>
            </div>
            ...
            <div style={{ display: 'flow-root' }}>
                <UpvoteComponent ItemID={r.review.id} UpvoteItem={UpvoteItems.GymReview} Upvotes={r.review.upvotes} BelongsToUser={r.review.reviewerId == GetUserID()}
